...
namespace TwentyOneVideos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                List<ExceptionEntity> Exceptions = ReadExceptions();    // Exceptions is the List name, not dB.
        ...
        private static List<ExceptionEntity> ReadExceptions()
        {
            ...
            string queryString = @"SELECT Id, ExceptionType, ExceptionMessage,
                                    TimeStamp FROM Exception";
